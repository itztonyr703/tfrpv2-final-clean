...
Config.Stores = {
    ...
    {shopType = "clothing", coords = vector4(-708.9, -151.68, 37.42, 117.3), width = 4, length = 4, showBlip = true}, 
    {shopType = "clothing", coords = vector4(-1192.61, -768.4, 17.32, 216.6), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(425.91, -801.03, 29.49, 177.79), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(-164.99, -302.25, 39.73, 260.73), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(75.39, -1398.28, 29.38, 6.73), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(-827.39, -1075.93, 11.33, 294.31), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(-1448.7, -238.45, 49.81, 44.18), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(9.22, 6515.74, 31.88, 131.27), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(615.35, 2762.72, 42.09, 170.51), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(1191.61, 2710.91, 38.22, 269.96), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(-3171.32, 1043.56, 20.86, 334.3), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(-1105.52, 2707.79, 19.11, 317.19), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(-1261.83, -1426.32, 4.37, 114.1), width = 4, length = 4, showBlip = true},
    {shopType = "clothing", coords = vector4(124.82, -224.36, 54.56, 335.41), width = 4, length = 4, showBlip = true},
	{shopType = "clothing", coords = vector4(-1217.19, -1429.8, 4.37, 218.19), width = 4, length = 4, showBlip = true},
	{shopType = "clothing", coords = vector4(462.85, -999.21, 30.69, 93.35), width = 4, length = 4, showBlip = false}, --police
	{shopType = "clothing", coords = vector4(105.26, -1303.16, 28.79, 291.65), width = 4, length = 4, showBlip = false}, --vanilla
	{shopType = "clothing", coords = vector4(146.46, -3008.19, 7.04, 268.17), width = 4, length = 4, showBlip = false}, --tuner
    ...
    {shopType = "barber", coords = vector4(-34.01, -154.46, 57.08, 333.71), width = 2, length = 2},	
    {shopType = "barber", coords = vector4(-278.1, 6228.5, 31.5, 49.32), width = 2, length = 2},
    {shopType = "barber", coords = vector4(-1197.98, -1517.45, 4.38, 117.83), width = 2, length = 2},	
    {shopType = "tattoo", coords = vector4(1322.4, -1651.9, 51.2, 42.47), width = 2, length = 2}, --paleto
    ...
    {shopType = "surgeon", coords = vector4(324.77, -597.0, 43.28, 69.72), width = 2, length = 2},
}

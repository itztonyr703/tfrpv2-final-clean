...
Config.Bikes = {
    [1] = { model = "bmx", label = "BMX", rental_cost = 25, available = true },
    [2] = { model = "cruiser", label = "Cruiser", rental_cost = 25, available = true },
    [3] = { model = "fixter", label = "Fixter", rental_cost = 25, available = true },
    [4] = { model = "scorcher", label = "Scorcher", rental_cost = 25, available = true },
    [5] = { model = "tribike", label = "Tribike", rental_cost = 25, available = true },
    [6] = { model = "tribike2", label = "Tribike 2", rental_cost = 25, available = true },
    [7] = { model = "tribike3", label = "Tribike 3", rental_cost = 25, available = true },
}
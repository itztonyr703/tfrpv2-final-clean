...
Config.BlowUpChance = 0 -- percentage for chance of engine explosion
Config.RefillCost = 150 -- default price
Config.CostMultiplier = 1.0 -- tax basically
Config.canCost = 25 -- buy jerry can price
Config.refuelCost = 150 -- refueling jerry can price
Config.GlobalTax = 0.5

Config.fuelPrice = 2.5 -- fuel price in litres I guess

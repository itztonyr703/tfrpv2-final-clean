...
Config.FrameworkTriggers = {
    load = 'QBCore:Client:OnPlayerLoaded', --[ ESX = 'esx:playerLoaded' / QBCore = 'QBCore:Client:OnPlayerLoaded' ] Set the player load event, if left blank, default will be used
...
Config.FrameworkSQLTables = {
    table = 'players', --[ ESX = 'users' / QBCore = 'players' ] Set the name of the table where you players, if left blank, default will be used
    identifier = 'citizenid', --[ ESX = 'identifier' / QBCore = 'citizenid' ] Set the identifier used in that table, if left blank, default will be used
}

Config.CommandPermission = 'admin' -- This permission group can use the /creategang command

Config.ZoneOptions = {
    showZoneInfo = false, -- Shows more information about zone in the right down corner of the screen (Hold Z key)
    ...
    maxSpraysPerHour = 0, -- Maximum number of sprays in an hour that increase loyalty

    rivalryCost = 25000, -- Minimum funds needed to start a rivalry in a zone
...
Config.GangOptions = {
    ...
    kidnapping = false, -- Enable kidnapping feature from gang menu

    ductTapeItem = 'ducttape', -- Put name of the duct tape item in case you want to remove it from player's inventory
    paperBagItem = 'paperbag', -- Put name of the paper bag item in case you want to remove it from player's inventory

    maxMembers = 11, -- Maximum amount of players in a gang
    minCopsForSell = 0, -- Minimum amount of cops on-duty needed for drug selling (You have to set the cop count by event)
}

Config.OtherOptions = {
    blackMoney = true, -- Receive black money instead of clean bills
    ...
    parameters = {
        {
            ...
            type = 'number' -- DO NOT TRANSLATE THIS
        },
        {
            name = 'color',
            help = 'Color of the gang.',
            type = 'string' -- DO NOT TRANSLATE THIS
        },
        {
            name = 'tag',
...
Config.Drugs = {
    CATEGORY_LOW = {
        ['weed_white-widow'] = 205,
        ['weed_skunk'] = 205,
        ['weed_purple-haze'] = 205,
        ['weed_og-kush'] = 205,
        ['weed_amnesia'] = 205,
        ['weed_ak47'] = 205,
        ['weed_lemonhaze'] = 205,
        ['weed_purple-haze'] = 205,
        ['weed_blue_dream'] = 205,
        ['weed_girl_scout_cookies'] = 205,
        ['weed_sour_diesel'] = 205,
        ['weed_cheese'] = 205,
        ['weed_pineapple_express'] = 205,
        ['weed_trainwreck'] = 205,
        ['weed_velvet_runtz'] = 205,
        ['weed_gelato'] = 205,
        ['weed_cherry_pie'] = 205,
        ['weed_lv_pk'] = 205,
        ['cokebaggy'] = 265,
...
-- Chances for drug selling
--[[
    The amount of drugs a player has sold serves as an index to this table
    A number between 1 and 100 will be generated each time
    All numbers in one table make up one hundred (percent)
    The first number is accept chance
    The second number is reject chance
    The third number is reject and dispatch chance
]]

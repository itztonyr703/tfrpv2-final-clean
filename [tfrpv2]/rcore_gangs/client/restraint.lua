...
RegisterNetEvent('rcore_gangs:playerDied')
AddEventHandler('rcore_gangs:playerDied', function(playerSrc)
    ...
    if ActiveHeadBags[playerSrc] then
        IsHeadBagged = false
                
        TriggerServerEvent('rcore_gangs:unheadbag', playerSrc)
        
        HeadBagOff(playerSrc)

...
Config.GymWait = 8000 -- Relaxing before next exercise
...
Config.StaminaX = 1.1 -- The amount you want to gain
...
Config.LungsX = 1.3 -- The amount you want to gain
Config.WaitNoGym = 20000 -- Time to be active outside the gym to gain

-- Complete Translation
Config.T = {
    ["1"] = "Ability of ",
    ["2"] = " has risen +",
    ["3"] = "You need to wait 8 seconds to do another exercise again",

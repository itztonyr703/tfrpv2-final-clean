...
Config.ScaleFormLists = {
    ["television_scaleform_1"] = true,
    ["television_scaleform_2"] = true,
    ["television_scaleform_3"] = true,
...
Config.resolution = {
 [GetHashKey("ch_prop_ch_tv_rt_01a")] = {
    ...
    [GetHashKey("vw_prop_vw_cinema_tv_01")] = {
        --Job = { ["police"] = {"*"},  },
        --ItemToOpen = { "remote", "dogecoin" },

        ScreenOffSet = vector3(-1.474400, -0.043770, 0.871280),
        ScreenSize = vector3(0.005125, 0.002870, 0.0),
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = 0.05,

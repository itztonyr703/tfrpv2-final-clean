...
Config.CokeProcessing = {
	CokeLeaf = 5, -- Amount of Leaf Needed to Process
	ProcessCokeLeaf = math.random(4,8), -- Amount of Coke Received
	-- Processing Small Bricks --
	Coke = 15, -- Amount of Coke Needed for Small Brick
...
Config.MethProcessing = {
	...
	Meth = math.random(24,46), -- Amount of Meth Recevied From 1 Tray
}
...
Config.HeroinProcessing = {
	Poppy = 10 -- Amount of Poppy Required for 1 Heroin
}
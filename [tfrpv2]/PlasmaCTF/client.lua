...
AddEventHandler('PaintBallCTF:SendtheBalls', function(blueBallsID,redBallsID,sessiondata)
	...
	if NetworkDoesNetworkIdExist(blueBallsID) then
		...
		FreezeEntityPosition(blueOrbsObject,true)
	else
	...
	if NetworkDoesNetworkIdExist(redBallsID) then
		...
		FreezeEntityPosition(redOrbsObject,true)
	else
	...
	blueSocleObject = NetworkGetEntityFromNetworkId(NetworkDoesNetworkIdExist(sessiondata.bbase))
	redSocleObject = NetworkGetEntityFromNetworkId(NetworkDoesNetworkIdExist(sessiondata.rbase))
	FreezeEntityPosition(blueSocleObject,true)
	FreezeEntityPosition(redSocleObject,true)

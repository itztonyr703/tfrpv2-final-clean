...
function updatePlants()
    ...
    exports.oxmysql:update(
        "UPDATE `plants` SET `growth`=`growth` + (0.01 * `rate`) , `food` = `food` - (0.02 * `rate`), `water` = `water` -  (0.02 * `rate`) WHERE (water >= 2 OR food >= 2) AND (growth < 100)",
        {},
        function()

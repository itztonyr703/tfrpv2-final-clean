...
Config.MaxAlarmVolume = 0.4        -- Maximum volume for alarms
...
Config.UseLockedAlarms = false      -- Thread For Triggering Car / Motorcycle Alarms
Config.AllowForcedEntry = true     -- Set whether you want the player to be able to force entry
Config.Debug = true

--Key mapping
Config.ToggleUi = 'O' --Defult NUMPAD ADD
Config.ToggleEngine = 'PAGEUP'
Config.ToggleLocks = 'NUMPAD SUBTRACT' --Defult NUMPAD SUBTRACT

...
Config.Sitable = {
	...
	imp_prop_impexp_offchair_01a 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.0, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	...
	v_corp_lazychair 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.65, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},
	prop_off_chair_01 			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = 0.65, forwardOffset = 0.0, sideOffset = 0.0, rotationOffset = 0.0},

...
Shared.BoostInterval = 10 -- How many minutes between new boost contracts
Shared.ExpireTime = 6 -- Amount of hours before the contract expires
Shared.VinPrice = 350 -- Price in crypto to make it a VIN Scratch
Shared.MinSpeed = 60 -- Minimum speed in MPH required to perform a hack
Shared.MinCops = 1 -- Minimum cops required for a drop-off
Shared.MinVinCops = 1 -- Minimum cops required for a vin scratch
Shared.LaptopAnimation = true -- Set to false if you don't want a tablet animation
Shared.FuelScript = 'ps-fuel' -- This is used for exports[Shared.FuelScript]:SetFuel(veh, 23.00), use lj-fuel if using loljoshie's version
Shared.Permission = 'god' -- The permission needed to use the createboost command, admin or god
Shared.MoneyType = 'bank' -- The money used to start a contract, make sure to edit the UI too in he app.js to fit your moneytype.

Shared.Ranks = { -- Here you can change the min and max reputation thresholds for the different ranks
    ['D'] = {
        minRep = 0,
        maxRep = 120
    },

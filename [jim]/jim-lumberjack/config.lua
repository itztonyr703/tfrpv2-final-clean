...
Config = {
	...
	Locations =  {
		['Lumberyard'] = {	 -- The location of the Lumberyard
			{ name = "Lumber Yard", coords = vector4(-552.63, 5348.79, 74.74, 68.82), sprite = 285, col = 2, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },
		},
		['Seller'] = {
			{ name = "Store", coords = vector4(-469.31, 5365.69, 80.79, 88.27), sprite = 431, col = 2, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },		-- The location where you enter the mine
		},
		['Buyer'] = {
			{ name = "Lumber Supply", coords = vector4(1219.98, -1269.71, 35.36, 85.67), sprite = 431, col = 21, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD", },		-- The location where you enter the mine
		},
		['Saws'] = { -- The location of the smelter
			{ name = "Wood Saw", coords = vector4(-523.46, 5283.61, 74.28, 70.0), sprite = 162, col = 24, blipTrue = true, prop = `prop_tablesaw_01` },
			{ name = "Wood Saw", coords = vector4(-522.32, 5286.87, 74.25, 70.0), sprite = 162, col = 24, blipTrue = false, prop = `prop_tablesaw_01` },
			{ name = "Wood Saw", coords = vector4(-525.02, 5279.09, 74.29, 70.0), sprite = 162, col = 24, blipTrue = false, prop = `prop_tablesaw_01` },
		},
		['WoodCut'] = {
		...
		['Illegal'] = {
			{ name = "Illegal Shit", coords = vector4(-181.16, 6155.01, 31.21, 307.58), sprite = 514, col = 0, blipTrue = false, prop = `gr_prop_gr_speeddrill_01b` },
		},
		["Debark"] = {
			{ name = "De-Barking", coords = vector4(-477.1, 5303.64, 86.05, 70.0), sprite = 162, col = 36, blipTrue = true },
			{ name = "De-Barking", coords = vector4(-475.82, 5305.81, 86.15, 70.0), sprite = 162, col = 36, blipTrue = false },
			{ name = "De-Barking", coords = vector4(-516.28, 5272.37, 80.49, 70.0), sprite = 162, col = 36, blipTrue = false },
		},
		["Pulper"] = {
			{ name = "Pulper", coords = vector4(-523.85, 5298.43, 78.79, 69), sprite = 162, col = 0, blipTrue = true },
		},
	},
...
--Ores and Props
	...
	Items = {
		...
		items = {
			{ name = "powersaw", price = 500, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "brisk_blackberry_smash", price = 10, amount = 100, info = {}, type = "item", slot = 2, },
			{ name = "jalapeno_cheese_taquito", price = 10, amount = 250, info = {}, type = "item", slot = 3, },

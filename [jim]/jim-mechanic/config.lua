print("^2Jim^7-^2Mechanic ^7v^42^7.^49^7.^48^3Coldfix ^7- ^2Mechanic Script by ^1Jimathy^7")
...
-- NOS STUFF
	NosRefillCharge = 100, -- amount in dollars required to refill a nos can

	NosTopSpeed = 18.0, -- Enabling this adds a multiplier to the top speed of the vehicle
	...
	NitrousUseRate = 0.9, -- How fast the nitrous drains (halved for level1, doubled for level3)
...
-- Discord preview receipts
	...
	DiscordDefault = "https://discord.com/api/webhooks/1015956775335379034/wWr5A1K1HoXOH59Zx9Ng0sXsZR9vKDfoJWd_u53riwpnkNYaEiULKY5a-cxsc1Mbi8Qz", -- Set this to the default channel API link if one isn't set for a location

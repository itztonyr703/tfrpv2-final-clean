print("^2Jim^7-^2Burgershot ^7v^42^7.^43^7.^46 ^7- ^2BurgerShot Job Script by Jimathy^7")
...
Config = {
	...
	MLO = "GN",     --use "LP" if you are using Smallo's burgershot MLO
	...
	Items = {
		...
		slots = 2,
		items = {
			{ name = 'kobe_pop', price = 10, amount = 50, info = {}, type = 'item', slot = 1, },
			{ name = 'lebronjames_pop', price = 10, amount = 50, info = {}, type = 'item', slot = 2, },
		},
	},
	Locations = {
		{
			...
			blipcolor = 5,
			garage = { spawn = vector4(-1173.0, -899.68, 13.58, 324.91),

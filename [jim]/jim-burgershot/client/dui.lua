...
if Config.MLO == "GN" then
	PresetList = {
		{ coords = vector3(-1194.07, -898.48, 15.97), radius = 0.6, tex = { texd = "gn_burgershot_graphi", texn = "gn_tv_screen_b", size = Size["big"], }, },
		{ coords = vector3(-1195.8, -895.76, 15.97), radius = 0.6, tex = { texd = "gn_burgershot_graphi", texn = "gn_tv_screen_c", size = Size["big"], }, },
		{ coords = vector3(-1194.93, -897.13, 15.97), radius = 0.6, tex = { texd = "gn_burgershot_graphi", texn = "gn_tv_screen_scrolling", size = Size["scrolling"], }, },
		{ coords = vector3(-1196.73, -894.39, 15.97), radius = 0.6, tex = { texd = "gn_burgershot_graphi", texn = "gn_tv_screen_d", size = Size["big"], }, },
	}
elseif Config.MLO == "LP" then
	PresetList = {
		{ coords = vector3(-1195.71, -891.03, 16.2), radius = 0.4, tex = { texd = "bs_cj_bs_post", texn = "cj_bs_pos1", size = Size["medium"], }, },
		{ coords = vector3(-1194.73, -892.36, 16.2), radius = 0.4, tex = { texd = "bs_cj_bs_post", texn = "cj_bs_pos2", size = Size["medium"], }, },
		{ coords = vector3(-1195.22, -891.68, 16.2), radius = 0.4, tex = { texd = "bs_cj_bs_post", texn = "cj_bs_pos4", size = Size["medium"], }, },
		{ coords = vector3(-1196.12, -890.36, 16.2), radius = 0.4, tex = { texd = "bs_cj_bs_post", texn = "cj_bs_pos3", size = Size["medium"], }, },
	}
elseif Config.MLO == "NP" then
	PresetList = {
		--Exterior
		{ coords = vector3(-1203.64, -887.29, 14.45), radius = 1.4, tex = { texd = "bs_ext_txd", texn = "bsjackie", size = Size["medium"], }, },
		{ coords = vector3(-1184.3, -904.93, 17.3), radius = 0.6, tex = { texd = "bs_ext_txd", texn = "bs_branding_waste", size = Size["wide"], }, },

		--Interior
		{ coords = vector3(-1198.00, -891.21, 15.0), radius = 0.7, tex = { texd = "bs_int_txd", texn = "bs_branding_porkhole_tx", size = Size["wide"], }, },
		{ coords = vector3(-1195.67, -892.35, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_menu_01", size = Size["tall"], }, },
		{ coords = vector3(-1196.09, -891.73, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_menu_02", size = Size["tall"], }, },
		{ coords = vector3(-1195.22, -892.96, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_menu_03", size = Size["tall"], }, },
		{ coords = vector3(-1193.19, -896.02, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_menu_04", size = Size["tall"], }, },
		{ coords = vector3(-1193.60, -895.42, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_menu_05", size = Size["tall"], }, },
		{ coords = vector3(-1194.00, -894.80, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_mmeal_01", size = Size["tall"], }, },
		{ coords = vector3(-1194.81, -893.57, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_heartstopper_01", size = Size["tall"], }, },
		{ coords = vector3(-1196.48, -891.12, 16.3), radius = 0.34, tex = { texd = "bs_int_txd", texn = "bs_bleeder_01", size = Size["tall"], }, },
	}
end
...
CreateThread(function()
	BurgerShotDUI = PolyZone:Create({
			vector2(-1244.4434814453, -887.61370849609),
			vector2(-1171.2486572266, -836.91143798828),
			vector2(-1135.0057373047, -889.05285644531),
			vector2(-1214.6118164062, -936.40856933594)},

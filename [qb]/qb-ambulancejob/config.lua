...
Config.HealthDamage = 0 -- Minumum damage done to health before checking for injuries
Config.ArmorDamage = 5 -- Minumum damage done to armor before checking for injuries
Config.ForceInjury = 0 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
...
Config.BleedTickRate = 0 -- How much time, in seconds, between bleed ticks
Config.BleedMovementTick = 0 -- How many seconds is taken away from the bleed tick rate if the player is walking, jogging, or sprinting
...
Config.FadeOutTimer = 0 -- How many bleed ticks occur before fadeout happens
Config.BlackoutTimer = 0 -- How many bleed ticks occur before blacking out
Config.AdvanceBleedTimer = 0 -- How many bleed ticks occur before bleed level increases
Config.HeadInjuryTimer = 0 -- How much time, in seconds, do head injury effects chance occur
Config.ArmInjuryTimer = 0 -- How much time, in seconds, do arm injury effects chance occur
Config.LegInjuryTimer = 0 -- How much time, in seconds, do leg injury effects chance occur
...
Config.DamageMinorToMajor = 0 -- How much damage would have to be applied for a minor weapon to be considered a major damage event. Put this at 100 if you want to disable it
Config.AlertShowInfo = 2 -- How many injuries a player must have before being alerted about them

Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] =  vector3(349.43, -587.78, 28.8),
		[2] =  vector3(308.66, -595.51, 42.30),
    },
    ["duty"] = {
        [1] = vector3(306.91, -597.44, 43.28),
    },
    ["vehicle"] = {
        [1] = vector4(294.578, -574.761, 43.179, 35.79),
        [2] = vector4(336.52, -581.29, 28.8, 352.44),
    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5),
    },
    ["armory"] = {
		[1] = vector3(306.75, -601.81, 43.28),
    },
    ["roof"] = {
         [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(332.3662, -595.5396, 43.2841),
		[2] = vector3(341.8829, -585.1607, 28.7988),
    },
    ["stash"] = {
        [1] = vector3(304.06, -599.66, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(307.74, -581.74, 44.2, 335.69), taken = false, model = 1631638868},
        [2] = {coords = vector4(311.14, -582.84, 44.2, 347.75), taken = false, model = 1631638868},
        [3] = {coords = vector4(314.55, -584.32, 44.2, 350.28), taken = false, model = 2117668672},
        [4] = {coords = vector4(317.75, -585.27, 44.2, 337.45), taken = false, model = 2117668672},
        [5] = {coords = vector4(322.71, -587.24, 44.2, 335.64), taken = false, model = 2117668672},
        [6] = {coords = vector4(324.25, -582.73, 44.2, 159.8), taken = false, model = -1091386327},
        [7] = {coords = vector4(313.93, -578.94, 44.2, 159.89), taken = false, model = -1091386327},
        [8] = {coords = vector4(309.3, -577.13, 44.2, 154.94), taken = false, model = -1091386327},
    },
    ["jailbeds"] = {

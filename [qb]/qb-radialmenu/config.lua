                ...
                items = {
                    {
                        ...
                        icon = 'key',
                        type = 'client',
                        event = 'qs-housing:client:giveHouseKey',
                        shouldClose = true
                    }, {
                        id = 'removehousekey',
                        ...
                        icon = 'key',
                        type = 'client',
                        event = 'qs-housing:client:removeHouseKey',
                        shouldClose = true
                    }, {
                        id = 'togglelock',
                        ...
                        icon = 'door-closed',
                        type = 'client',
                        event = 'qs-housing:client:toggleDoorlock',
                        shouldClose = true
                    }, {
                        id = 'decorate',
                        ...
                        icon = 'box',
                        type = 'client',
                        event = 'qs-housing:client:decorate',
                        shouldClose = true
                    }, {
                        id = 'houseLocations',
                        ...
                        items = {
                            {
                                ...
                                icon = 'box-open',
                                type = 'client',
                                event = 'qs-housing:client:setLocation',
                                shouldClose = true
                            }, {
                                id = 'setwardrobe',
                                title = 'Set Wardrobe',
            ...
            items = {
                {
                    ...
                    icon = 'plus',
                    type = 'client',
                    event = 'gl-ambulance:useStretcher',
                    shouldClose = false
                }, {
                    id = 'despawnstretcher',
                    ...
                    icon = 'minus',
                    type = 'client',
                    event = 'gl-ambulance:delStretcher',
                    shouldClose = false
                }
            }
        }
            ...
            items = {
                {
					...
					id = 'tryTreatingPlayer',
					title = 'Heal wounds',
					icon = 'bandage',
					type = 'client',
					event = 'gl-ambulance:client:tryTreatingPlayer',
					shouldClose = true
				}, {

...
Garages = {
    ...
    ['impoundlot'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
			vector2(-129.14282226563, -1186.3198242188),
			vector2(-129.14785766602, -1174.6251220703),
			vector2(-136.30949401855, -1174.4207763672),
			vector2(-142.58251953125, -1169.9075927734),
			vector2(-141.77536010742, -1165.7355957031),
			vector2(-139.02766418457, -1162.4018554688),
			vector2(-136.97288513184, -1158.6518554688),
			vector2(-153.98059082031, -1158.5511474609),
			vector2(-153.77532958984, -1186.3159179688)
            },
            ['minZ'] = 24.928073883057,  -- min height of the parking zone
            ['maxZ'] = 25.4527759552,  -- max height of the parking zone
            debug = false,
        },
        label = "Impound Lot",
        showBlip = true,
        blipcoords = vector3(-143.44, -1177.55, 25.16),
        SpawnDistance = 15.0,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-151.5, -1176.26, 25.11, 276.9),
			vector4(-151.02, -1172.4, 25.17, 271.13),
			vector4(-150.25, -1169.12, 25.22, 264.08),
			vector4(-150.07, -1165.0, 25.28, 275.18),
			vector4(-149.92, -1161.25, 25.3, 270.78),
			vector4(-135.11, -1177.21, 25.28, 89.77),
			vector4(-134.75, -1181.68, 25.28, 80.81)
        }
    },
    ['police'] = {
        ['Zone'] = {
    ...
    ['airdepot'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
				vector2(-936.22863769531, -3073.6354980469),
				vector2(-969.1640625, -3142.0622558594),
				vector2(-1013.9044189453, -3114.2419433594),
				vector2(-1008.9904785156, -3095.0727539063),
				vector2(-1022.0062866211, -3073.6586914063),
				vector2(-1105.84765625, -3025.421875),
				vector2(-1093.1162109375, -2985.9953613281)
            },
            ['minZ'] = 13.944311141968,  -- min height of the parking zone
            ['maxZ'] = 13.964530944824,  -- max height of the parking zone
        },
        label = 'Air Depot',
        type = 'depot',
        ...
        blipNumber = 569,
        blipColor = 33,
        blipcoords = vector3(-1043.13, -3034.61, 13.96),
        ParkingDistance = 1000.0,
        debug = false,
        ['ParkingSpots'] = {
           vector4(-1024.0, -3045.44, 13.94, 239.42),
            vector4(-1064.73, -3020.53, 13.94, 58.52),
            vector4(-1061.01, -3009.64, 13.96, 331.73)
        },
    },
    ['boathouse1'] = {
        ['Zone'] = {
 ...
 ['recyparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
			vector2(778.81427001953, -1417.9742431641),
			vector2(779.21740722656, -1399.8687744141),
			vector2(752.64733886719, -1399.5698242188),
			vector2(752.35498046875, -1417.9949951172)
            },
            ['minZ'] = 26.528629302979,  -- min height of the parking zone
            ['maxZ'] = 27.019559860229,  -- max height of the parking zone
        },
        label = "Recycling Parking",
        showBlip = true,
        blipcoords = vector3(774.26, -1411.47, 26.72),
		ParkingDistance = 100.0,
        SpawnDistance = 10.0,
        blipName = "Public Parking",
        blipNumber = 357,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(763.28, -1402.74, 26.52, 183.48),
            vector4(759.07, -1402.21, 26.52, 186.12),
            vector4(755.14, -1402.46, 26.54, 165.97),
			vector4(750.94, -1402.26, 26.54, 184.99),
            vector4(756.45, -1414.23, 26.53, 358.54),
            vector4(762.94, -1414.01, 26.51, 347.26),
            vector4(768.68, -1412.51, 26.49, 3.67),
			vector4(750.34, -1402.78, 26.55, 178.49),
			vector4(762.86, -1403.79, 26.52, 184.81),
			vector4(766.25, -1403.35, 26.51, 175.0),
			vector4(770.8, -1404.11, 26.52, 169.84),
			vector4(767.29, -1409.4, 26.51, 86.97),
			vector4(762.51, -1409.24, 26.53, 272.09),
			vector4(758.57, -1413.96, 26.52, 356.71),
			vector4(764.22, -1413.42, 26.51, 357.31),
			vector4(769.22, -1413.51, 26.49, 355.7)
        }
    },
	 ['tunerparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
				vector2(158.98971557617, -3039.5373535156),
				vector2(159.22378540039, -3063.7810058594),
				vector2(172.45164489746, -3065.1181640625),
				vector2(172.48307800293, -3039.3557128906)
            },
            ['minZ'] = 5.7684206962585,  -- min height of the parking zone
            ['maxZ'] = 6.0139632225037,  -- max height of the parking zone
        },
        label = "Tuner Parking",
        showBlip = true,
        blipcoords = vector3(169.71, -3048.83, 5.82),
		ParkingDistance = 100.0,
        SpawnDistance = 10.0,
        blipName = "Public Parking",
        blipNumber = 357,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(162.75, -3041.99, 5.95, 269.39),
            vector4(163.15, -3046.22, 5.94, 261.75),
            vector4(163.49, -3050.65, 5.93, 272.36),
			vector4(163.75, -3054.93, 5.93, 260.54),
            vector4(164.15, -3059.16, 5.92, 267.5),
            vector4(164.52, -3062.75, 5.91, 281.35),
			vector4(168.72, -3059.25, 5.84, 267.45),
			vector4(168.78, -3055.33, 5.84, 264.36),
			vector4(168.82, -3051.33, 5.83, 264.2),
			vector4(168.73, -3047.32, 5.84, 268.65),
			vector4(168.66, -3043.39, 5.84, 267.5),
			vector4(168.26, -3041.48, 5.85, 264.1)
        }
    },
	['triadparking'] = {
        ['Zone'] = {
            ['Shape'] = { -- Create a polyzone by using '/pzcreate poly', '/pzadd' and '/pzfinish' or '/pzcancel' to cancel it. the newly created polyzone will be in txData/QBCoreFramework_******.base/polyzone_created_zones.txt
				vector2(-651.93182373047, -1208.9040527344),
				vector2(-646.75018310547, -1205.0726318359),
				vector2(-634.86181640625, -1224.0010986328),
				vector2(-640.66546630859, -1227.9937744141),
				vector2(-651.18865966797, -1212.0574951172)
            },
            ['minZ'] = 10.877058982849,  -- min height of the parking zone, cannot be the same as maxZ, and must be smaller than maxZ
            ['maxZ'] = 12.095405578613,  -- max height of the parking zone
            -- Important: Make sure the parking zone is high enough - higher than the tallest vehicle and touches the ground (turn on debug to see)
        },
        label = 'Triad Parking', -- label displayed on phone
        type = 'gang', -- 'public', 'job', 'depot' or 'gang'
        showBlip = false, -- optional, when not defined, defaults to false
        blipName = 'Triad Parking', -- otional
        blipNumber = 90, -- optional, numbers can be found here: https://docs.fivem.net/docs/game-references/blips/
        blipColor = 69, -- optional, defaults to 3 (Blue), numbers can be found here: https://docs.fivem.net/docs/game-references/blips/
        blipcoords = vector3(-643.61, -1216.15, 11.45), -- blip coordinates
        gang = 'triads', -- optional, same as job but for gangs, do not use both
        -- gang = {'vagos', 'gsf'}, -- optional, multi gang support
        ...
        ParkingDistance = 100.0, -- Optional ParkingDistance, to override the global ParkingDistance
        SpawnDistance = 15.0, -- Optional SpawnDistance, to override the global SpawnDistance
        debug = false, -- will show the polyzone and the parking spots, helpful when creating new garages. If too many garages are set to debug, it will not show all parking lots
        ['ParkingSpots'] = {
            vector4(-646.86, -1211.55, 11.35, 310.12),
            vector4(-645.34, -1214.61, 11.35, 298.82),
			vector4(-643.09, -1217.63, 11.43, 295.83),
			vector4(-641.24, -1220.67, 11.46, 303.2),
			vector4(-639.36, -1223.86, 11.49, 305.33)
        }
    },
	['pierparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
				vector2(-1599.5340576172, -1013.4841308594),
				vector2(-1591.4816894531, -1004.5844116211),
				vector2(-1586.9670410156, -1007.7647705078),
				vector2(-1554.1513671875, -969.26788330078),
				vector2(-1546.6148681641, -975.22796630859),
				vector2(-1541.4694824219, -969.98571777344),
				vector2(-1520.8033447266, -987.17126464844),
				vector2(-1576.2650146484, -1053.1427001953),
				vector2(-1590.2937011719, -1060.1026611328),
				vector2(-1613.4050292969, -1040.2846679688),
				vector2(-1603.4689941406, -1025.2036132813)
            },
            ['minZ'] = 13.017504692078,  -- min height of the parking zone
            ['maxZ'] = 13.154317855835,  -- max height of the parking zone
        },
        label = "Pier Parking",
        showBlip = true,
        blipcoords = vector3(-1568.98, -1014.95, 13.02),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-1594.1, -1012.96, 13.02, 263.13),
            vector4(-1591.32, -1010.34, 13.02, 255.4),
			vector4(-1583.27, -1008.87, 13.02, 250.72),
			vector4(-1581.22, -1006.13, 13.02, 254.82),
            vector4(-1578.12, -1003.19, 13.02, 246.04),
            vector4(-1575.97, -1000.14, 13.02, 247.78),
			vector4(-1573.34, -997.3, 13.02, 256.72),
			vector4(-1571.34, -994.46, 13.02, 252.35),
			vector4(-1568.93, -991.46, 13.02, 246.97),
			vector4(-1567.01, -988.39, 13.02, 245.51),
			vector4(-1564.87, -985.49, 13.02, 245.59),
			vector4(-1561.89, -982.98, 13.02, 249.12),
			vector4(-1559.42, -980.04, 13.02, 253.28),
			vector4(-1556.49, -977.33, 13.02, 256.96),
			vector4(-1554.5, -974.32, 13.02, 247.04),
			vector4(-1542.44, -974.13, 13.02, 143.68),
			vector4(-1539.59, -976.29, 13.02, 136.26),
			vector4(-1537.42, -978.45, 13.02, 137.64),
			vector4(-1534.71, -980.59, 13.02, 138.07),
			vector4(-1532.28, -982.8, 13.02, 136.74),
			vector4(-1530.05, -985.33, 13.02, 132.13),
			vector4(-1546.89, -985.71, 13.02, 10.54),
			vector4(-1549.41, -987.59, 13.02, 22.28),
			vector4(-1551.91, -990.92, 13.02, 11.05),
			vector4(-1554.32, -993.53, 13.02, 16.2),
			vector4(-1556.46, -996.37, 13.02, 24.62),
			vector4(-1558.93, -999.58, 13.02, 22.97),
			vector4(-1561.29, -1002.06, 13.02, 21.78),
			vector4(-1563.85, -1005.39, 13.02, 25.57),
			vector4(-1566.09, -1008.15, 13.02, 22.77),
			vector4(-1568.7, -1010.85, 13.02, 26.06),
			vector4(-1570.92, -1013.9, 13.02, 33.15),
			vector4(-1573.18, -1016.95, 13.02, 17.84),
			vector4(-1575.53, -1020.15, 13.02, 27.84),
			vector4(-1577.95, -1022.6, 13.02, 28.22),
			vector4(-1585.06, -1031.31, 13.02, 28.41),
			vector4(-1582.8, -1028.19, 13.02, 22.22),
			vector4(-1587.56, -1034.25, 13.02, 24.83),
			vector4(-1590.16, -1037.04, 13.02, 28.23)		
        }
    },
}

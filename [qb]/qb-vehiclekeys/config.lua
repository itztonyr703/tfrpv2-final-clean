...
-- Carjack Settings
Config.CarjackingTime = 1500 -- How long it takes to carjack
...
-- Hotwire Settings
Config.HotwireChance = 90.5 -- Chance for successful hotwire or not
Config.TimeBetweenHotwires = 1500 -- Time in ms between hotwire attempts
Config.minHotwireTime = 3000 -- Minimum hotwire time in ms
Config.maxHotwireTime = 4000 --  Maximum hotwire time in ms

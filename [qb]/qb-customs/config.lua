...
Config.DefaultRepairPrice = 8000 -- Repair price that is used if a vehicle-specific price is not available
Config.BaseRepairPrice = 8000 -- Starting repair price. Every player's vehicle damage (0-1000) is added to it later. If the final price is 0 or less, the repair menu does not appear
Config.RepairPriceMultiplier = 0.0 -- Every player's vehicle damage (0-1000) is multiplier by this number, and then added to the base repair price
...
vehicleCustomisationPrices = {
    cosmetics = {price = 999999999},
    respray = {price = 999999999},
    performance = {prices = {0, 999999999, 999999999, 999999999, 999999999, 999999999, 999999999}},
    turbo = {prices = {0, 999999999}},
    wheels = {price = 999999999},
    customwheels = {price = 999999999},
    wheelsmoke = {price = 999999999},
    windowtint = {price = 999999999},
    neonside = {price = 999999999},
    neoncolours = {price = 999999999},
    headlights = {price = 999999999},
    xenoncolours = {price = 999999999},
    oldlivery = {price = 999999999},
    plateindex = {price = 999999999}
}

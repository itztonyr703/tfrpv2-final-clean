...
RegisterNetEvent('qb-bankrobbery:server:TrollyReward', function(type, bank, index)
    ...
    if type == 'gold' then
        ...
        exports['qb-inventory']:AddItem(src, 'goldbar', receiveAmount, false)
...
RegisterNetEvent('qb-bankrobbery:server:LockerReward', function(type, bank, index)
    ...
    if type == 'fleeca' then
        ...
        elseif tier == 3 then
            --blue usb
            exports['qb-inventory']:AddItem(src, 'usb_blue', 1)
    ...
    elseif type == 'paleto' then
        ...
        elseif tier == 3 then
            --red usb
            exports['qb-inventory']:AddItem(src, 'usb_red', 1)
    ...
    elseif type == 'pacific' then
        ...
        elseif tier == 3 then
            --usb_gold
            exports['qb-inventory']:AddItem(src, 'usb_gold', 1)
...
RegisterNetEvent('qb-bankrobbery:server:RemoveGreenCard', function()
    ...
    exports['qb-inventory']:RemoveItem(Player.PlayerData.source, 'security_card_01', 1, false)
...
RegisterNetEvent('qb-bankrobbery:server:RemoveGoldCard', function()
    ...
    exports['qb-inventory']:RemoveItem(Player.PlayerData.source, 'security_card_02', 1, false)
...
QBCore.Functions.CreateUseableItem("laptop_green", function(source, item)
	...
	if exports['qb-inventory']:GetItemByName(source, item.name) then

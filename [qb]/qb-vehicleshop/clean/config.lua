...
Config.Shops = {
    ...
    [2] = {
        category = 'police',
        coords = vector3(435.8071, -975.3903, 25.7000),
        spawnvehicle = vector4(198.5969, -999.3381, -99.0000, 132.5236), -- Display Point
        cameracoords = vector3(198.7576, -1007.2697, -99.0000), -- Where To Create Camera
        pointcamera = vector3(198.7576, -1007.2697, -99.0000), -- Where To Point Camera
        buyspawn = vector4(430.8606, -978.3705, 25.7000, 177.7243), -- Where Vehicle Spawns on Buy
        testdrive = vector4(430.8606, -978.3705, 25.7000, 177.7243) -- Where Vehicle Spawns on Test Drive
    },
    [3] = {
        category = 'ambulance',

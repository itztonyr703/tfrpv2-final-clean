...
-- Main Menus
local menu1 = MenuV:CreateMenu(false, Lang:t("menu.admin_menu"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test1')
local menu2 = MenuV:CreateMenu(false, Lang:t("menu.admin_options"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test2')
local menu3 = MenuV:CreateMenu(false, Lang:t("menu.manage_server"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test3')
local menu4 = MenuV:CreateMenu(false, Lang:t("menu.online_players"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test4')
local menu5 = MenuV:CreateMenu(false, Lang:t("menu.vehicle_options"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test5')
local menu6 = MenuV:CreateMenu(false, Lang:t("menu.dealer_list"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test6')
local menu7 = MenuV:CreateMenu(false, Lang:t("menu.developer_options"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test7')

--Sub Menus
local menu8 = MenuV:CreateMenu(false, Lang:t("menu.weather_conditions"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test8')
local menu9 = MenuV:CreateMenu(false, Lang:t("menu.ban"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test9')
local menu10 = MenuV:CreateMenu(false, Lang:t("menu.kick"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test10')
local menu11 = MenuV:CreateMenu(false, Lang:t("menu.permissions"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test11')
local menu12 = MenuV:CreateMenu(false, Lang:t("menu.vehicle_categories"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test12')
local menu13 = MenuV:CreateMenu(false, Lang:t("menu.vehicle_models"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test13')
local menu14 = MenuV:CreateMenu(false, Lang:t("menu.entity_view_options"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test14')
local menu15 = MenuV:CreateMenu(false, Lang:t("menu.spawn_weapons"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv', 'test15')
...
local function OpenPlayerMenus(player)
    local Players = MenuV:CreateMenu(false, player.cid .. Lang:t("info.options"), menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv') -- Players Sub Menu
    Players:ClearItems()
...
local function OpenDealerMenu(dealer)
    local EditDealer = MenuV:CreateMenu(false, Lang:t("menu.edit_dealer") .. dealer["name"], menuLocation, 168, 109, 227, 'size-125', 'none', 'menuv')

...
Config.Rewards = {
    [1] = {
        ["cabin"] = {"plastic", "diamond_ring", "goldchain", "purple_haze_weed", "thermite", "cryptostick", "weapon_golfclub", "hackcard"},
        ["kitchen"] = {"potato_wedges", "rockstar", "goldchain"},
        ["chest"] = {"plastic", "rolex", "diamond_ring", "goldchain", "purple_haze_weed", "thermite", "cryptostick", "weapon_combatpistol", "advancedlockpick"},
        ["livingroom"] = {"plastic", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "pistol_ammo", "security_card_01", "decryptor"}
    }
}

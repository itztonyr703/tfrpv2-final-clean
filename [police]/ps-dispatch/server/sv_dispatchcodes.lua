...
dispatchCodes = {
	...
	["oxyruns"] = {displayCode = '10-18', description = "Suspicious Handoff Spotted", radius = 0, recipientList = {'police'}, blipSprite = 66, blipColour = 37, blipScale = 0.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},

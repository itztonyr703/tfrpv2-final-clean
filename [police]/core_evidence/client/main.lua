    ...
    function()
        while true do
            ...
            if canAccess then
              ...
              for _,v in ipairs(Config.EvidenceAlanysisLocation) do
                if GetDistanceBetweenCoords(coords,v) < 1.5 then
...
Citizen.CreateThread(
    function()
        while true do
            ...
            if
                (IsShockingEventInSphere(102, coords, 200.0) or
                    IsShockingEventInSphere(95, coords, 200.0)) and HasPedBeenDamagedByWeapon(ped, 0 , 2)
             then

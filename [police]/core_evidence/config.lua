...
EvidenceReportInformationBullet = "name", -- The information displayd from players table in mysql in the evidence report (ONLY CHANGE IF YOU KNOW WHAT ARE YOU DOING)
EvidenceReportInformationFingerprint = "name", -- The information displayd from players table in mysql in the evidence report (ONLY CHANGE IF YOU KNOW WHAT ARE YOU DOING)
EvidenceReportInformationBlood = "name", -- The information displayd from players table in mysql in the evidence report (ONLY CHANGE IF YOU KNOW WHAT ARE YOU DOING)
...
EvidenceAlanysisLocation = {  -- The place where the evidence will be analyzed and report generated
vector3(483.6118, -987.9518, 30.6898)
},
...
EvidenceStorageLocation ={ -- The place where all evidence are being archived! You can view old evidence or delete it
 vector3(485.6332, -984.1201, 30.6898)
}, 
--
